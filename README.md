...
A modern Snake game built with pure HTML5 Canvas and Web Audio API.
...
- Smooth canvas-based movement with delta-time physics
- 14 skins — 8 unlocked as you level up, 6 more bought for coins in the shop
